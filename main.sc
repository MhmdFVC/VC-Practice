...
// Practice SCM - no locked pickups
//PRINTWORKS PURCHASING PICKUP
VAR_INT print_works_pickup
CREATE_FORSALE_PROPERTY_PICKUP printbuyX printbuyY printbuyZ printworks_price PRNT_NO print_works_pickup//You cannot buy the Print Works at this time, come back later.

//CAR SHOWROOM PURCHASING PICKUP
VAR_INT carbuy_pickup
CREATE_FORSALE_PROPERTY_PICKUP carbuyX carbuyY carbuyZ carbuy_price CAR_NO carbuy_pickup//You cannot buy the Car Showroom at this time, come back later.

//FILM STUDIO PURCHASING PICKUP
VAR_INT pornbuy_pickup
CREATE_FORSALE_PROPERTY_PICKUP pornbuyX pornbuyY pornbuyZ pornbuy_price PORN_NO pornbuy_pickup//You cannot buy the Film Studio at this time, come back later.

//ICECREAM FACTORY PURCHASING PICKUP
VAR_INT icebuy_pickup
CREATE_FORSALE_PROPERTY_PICKUP icebuyX icebuyY icebuyZ icebuy_price ICE_NO icebuy_pickup//You cannot buy the Icecream Factory at this time, come back later.

//TAXI FIRM PURCHASING PICKUP
VAR_INT taxibuy_pickup
CREATE_FORSALE_PROPERTY_PICKUP taxibuyX taxibuyY taxibuyZ taxibuy_price TAXI_NO taxibuy_pickup//You cannot buy the Taxi Company at this time, come back later.

//MALIBU CLUB PURCHASING PICKUP
VAR_INT bankbuy_pickup
CREATE_FORSALE_PROPERTY_PICKUP bankbuyX bankbuyY bankbuyZ bankbuy_price BANK_NO bankbuy_pickup//You cannot buy The Malibu at this time, come back later.

//BOAT YARD PURCHASING PICKUP
VAR_INT boatbuy_pickup
CREATE_FORSALE_PROPERTY_PICKUP boatbuyX boatbuyY boatbuyZ boatbuy_price BOAT_NO boatbuy_pickup//You cannot buy the Boat Yard at this time, come back later.
CREATE_FORSALE_PROPERTY_PICKUP strpbuyX strpbuyY strpbuyZ strpbuy_price STRP_NO strpbuy_pickup//Press R3 to purchase the Car Showroom for $~1~ 
...
WAIT mission_trigger_wait_time
	IF IS_PLAYER_PLAYING player1
		// Square -1120.75 -1293.0 / -1202.0 -1337.75
		IF LOCATE_PLAYER_ANY_MEANS_2D player1 -1161.0 -1315.375 41.0 22.375 FALSE
...
{
practice2_mission_loop:
SCRIPT_NAME PRACLP2
practice2_mission_loop_inner:
WAIT mission_trigger_wait_time
	IF IS_PLAYER_PLAYING player1
		// Square -1120.75 -1293.0 / -1174.0 -1249.5
		IF LOCATE_PLAYER_ANY_MEANS_2D player1 -1147.4 -1271.25 27.0 21.75 FALSE
			IF flag_player_on_mission = 0
				IF selecting = 0
					LOAD_AND_LAUNCH_MISSION practice2.sc
				ENDIF
			ENDIF
		ENDIF
	ENDIF
	GOTO practice2_mission_loop_inner
}
...
WAIT mission_trigger_wait_time
	...
	ENDIF
	IF IS_PLAYER_PLAYING player1
		IF LOCATE_PLAYER_ON_FOOT_3D player1 -1146.976807 -1287.038574 14.880610 1.5 2.0 2.0 FALSE
			IF flag_player_on_mission = 0
				IF CAN_PLAYER_START_MISSION player1
					GOSUB general_script_cut
					GOSUB make_player_safe
					...
					GOSUB get_fading_status
					LOAD_AND_LAUNCH_MISSION ahod.sc
				ENDIF
			ENDIF
		ENDIF
	ENDIF
...
WAIT mission_trigger_wait_time
	...
	ENDIF
	IF IS_PLAYER_PLAYING player1
		IF LOCATE_PLAYER_ON_FOOT_3D player1 -1148.422974 -1290.974487 14.881677 2.0 2.0 2.0 FALSE
			IF flag_player_on_mission = 0
				IF CAN_PLAYER_START_MISSION player1
					GOSUB make_player_safe
					PRINT_BIG ( TEX_1 ) 15000 2 //"sergio mission 1"
					GOSUB get_fading_status
					LOAD_AND_LAUNCH_MISSION 4fe.sc
				ENDIF
			ENDIF
		ENDIF
	ENDIF
...
WAIT mission_trigger_wait_time
	IF IS_PLAYER_PLAYING player1
		IF LOCATE_PLAYER_ON_FOOT_3D player1 sergioX sergioY sergioZ 2.0 2.0 2.0 FALSE
			IF flag_player_on_mission = 0
				IF CAN_PLAYER_START_MISSION player1
					selecting = 0
					GOSUB make_player_safe
...
/////////// Shakedown (not used in prac mission)
// protect Mission 1
{
