...
SET_PLAYER_COORDINATES player1 486.981110 52.809456 10.901540 // Practice SCM
...
REQUEST_MODEL m4
REQUEST_MODEL ZEBRA // Practice SCM
...
OR NOT HAS_MODEL_LOADED ZEBRA // Practice SCM
	WAIT 0
ENDWHILE
...
//creating candy
CREATE_CHAR PEDTYPE_CIVFEMALE SPECIAL01 489.549316 37.051342 10.901540 slut // Practice SCM
...
SET_CHAR_OBJ_GOTO_COORD_ON_FOOT slut 485.301361 41.195415	// Practice SCM
ADD_BLIP_FOR_CHAR slut slut_blip
SET_CHAR_NEVER_TARGETTED slut TRUE 

//creating car
CREATE_CAR stretch 487.774597 41.391376 10.901540 stretch_limo // Practice SCM
...
// Practice SCM - creating taxi and teleporting tommy into it. Also om0
CREATE_CAR ZEBRA 566.008606 73.462891 9.907267 cab
SET_CAR_HEADING cab 180.0
WARP_PLAYER_INTO_CAR player1 cab
...
///////// Practice SCM - Offset adjustment area
WAIT 0
WAIT 0
WAIT 0
WAIT 0
...
/* For ez mode (i.e. can use the wait 1000 to instapass), use below values instead
// and uncomment the first four PRINT_HELPs helps
WAIT 0 
WAIT 0
WAIT 0
WAIT 0
...
//camera help text
// Practice SCM - commenting out some of this crap so I have room to add practice conveniences -> adjust byte count with waits
IF help_cam = 0
	IF timera  < 7000 
		IF help_cam_msg = 0 
			IF controlmode = 0
		...
		IF NOT IS_CHAR_DEAD limo_driver 	
			IF slut_in_car = 0
				IF IS_CHAR_IN_CAR slut stretch_limo	
					...
					slut_in_car = 1
				ELSE
					IF LOCATE_CHAR_ON_FOOT_2D slut 482.036560 38.713959 100.0 100.0 FALSE // Practice SCM
...
//START_NEW_SCRIPT porn_mission4_loop // Practice SCM - this won't affect the offset for taxi IP anyway so whatever
...
MARK_MODEL_AS_NO_LONGER_NEEDED ZEBRA // Practice SCM
CLEAR_ONSCREEN_COUNTER pictures_taken
REMOVE_ROUTE 1 
REMOVE_ROUTE 2
REMOVE_ROUTE 3
