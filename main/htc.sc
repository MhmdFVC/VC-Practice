...
// Mission start stuff
VAR_INT frame_counter mission_blip
VAR_FLOAT gosub_car_to_slow_speed temp_float_x temp_float_y forward_x forward_y temp_y
VAR_FLOAT gosub_car_to_slow_x gosub_car_to_slow_y gosub_target_car_x gosub_target_car_y
...
REQUEST_MODEL CHEETAH // Practice SCM
...
// Practice SCM
IF htc_vehicle = 1
	CREATE_CAR CHEETAH -1053.618774 -277.617035 11.338552 htc_cheetah
ELSE 
	CREATE_CAR PCJ600 -1053.618774 -277.617035 11.338552 htc_pcj
ENDIF
/////////
...
// Practice SCM - that bitch sky high
CREATE_CHAR PEDTYPE_GANG_STREET HFYBU -1053.794678 -278.640717 50.0 courier
...
flag_player_on_mission = 0 // Practice SCM 
...
MARK_MODEL_AS_NO_LONGER_NEEDED CHEETAH // Practice SCM
