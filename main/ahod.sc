...
VAR_INT audio_12_flag audio_13_flag audio_14_flag audio_15_flag audio_16_flag
VAR_INT audio_12_timeout audio_13_timeout audio_14_timeout audio_15_timeout audio_16_timeout
VAR_INT cs_dude1 cs_dude2 temp_int

VAR_FLOAT heading_diff
...
// PRACTICE SCM MAIN STUFF !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// Mission flags to get the mission to a good spot
boat01_dead = 1
boat02_dead = 1
boat03_dead = 1
cutscene_counter = 5
...
SET_OBJECT_PATH_POSITION the_path_spline 2800.0
WAIT 500
FREEZE_CHAR_POSITION scplayer FALSE
first_boats_dead = 3
the_yacht_speed = 100.0

// etc. for suicide prac
flag_player_on_mission = 0 // om0
CANCEL_OVERRIDE_RESTART // so you don't respawn at the practice area and "dupe" it

flag_lawyer_mission2_passed = 1 // Enabling the phone
